...
class Day3:
    ...
    def part1(self):
        ...
        The submarine has been making some odd creaking noises, so you ask it to produce a diagnostic report just in
        case.
        ...
        # we know the binary numbers are 12-bits long just by watching the input
        # but what if we didn't?
        # let's measure the first of the entries
        ...
        gamma_rate = Utilities.str_to_dec(gamma_rate, data_length)
        epsilon_rate = Utilities.str_to_dec(epsilon_rate, data_length)
    ...
    def part2(self):
        ...
        Start with all 12 numbers and consider only the first bit of each number. There are more 1 bits (7) than
        0 bits (5), so keep only the 7 numbers with a 1 in the first position: 11110, 10110, 10111, 10101, 11100,
        10000, and 11001.
